...
# NOTE: save_data moved to after all annotations (region, has_dmp, win_beta)
...
# Mean beta per window (from Level 1 data) — needed by batch11 for beta-matching
...
# Save with all annotations (region, has_dmp, cpg_density, win_beta)
